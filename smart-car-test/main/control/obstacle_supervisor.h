...
typedef enum {
    ...
    OBSTACLE_TRANSITION_TO_STRAFE_LEFT_EDGE,
    OBSTACLE_TRANSITION_TO_STRAFE_LEFT_CLEARANCE,
    OBSTACLE_TRANSITION_TO_SETTLE_FORWARD,
    OBSTACLE_TRANSITION_TO_FORWARD_BYPASS,
    OBSTACLE_TRANSITION_TO_SETTLE_RIGHT,
    OBSTACLE_TRANSITION_TO_STRAFE_RIGHT_LINE,
...
typedef struct {
    ...
    int64_t line_search_started_us;
